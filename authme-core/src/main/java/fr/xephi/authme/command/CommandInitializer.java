...
public class CommandInitializer {
    ...
    private CommandDescription buildAuthMeBaseCommand() {
        ...
        CommandDescription.builder()
            ...
            .detailedDescription("Bypass, force-set, reset, or query a player's email verification state.")
            .withArgument(new CommandArgumentDescription("action", "bypass | set | unverify | status", MANDATORY)
                .withSuggestions("bypass", "set", "unverify", "status"))
            .withArgument(new CommandArgumentDescription("player", "Player name", MANDATORY)
